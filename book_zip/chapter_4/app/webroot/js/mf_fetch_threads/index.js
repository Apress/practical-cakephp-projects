        ...
        {   asynchronous:true, 
            ...
            onComplete: function(response,json){
                ...
                if ( json[ 'result' ] == '1' ) {
                    ...
                    message_links += '<a href="/cake/__chapters__/message_forum/MfFetchMessages/index/threadId:'+thread_id+'/">List Messages</a> |';
                    message_links += '<a href="/cake/__chapters__/message_forum/MfMessageForm/index/reply_to:'+message_id+'/thread_id:'+thread_id+'/">Reply</a>';
                    message_links += '</div>';
