...
<?php     
  ...
  <?=$form->hidden('Order.id', array( 'value'=>$cartContent['ct']['id']));?>
  </td>
...
<table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
 <tr align="center"> 
  ...
  <?php	
  	...
  	$str = implode("_", $str);
  echo $form->button('Proceed To Checkout', array( 'class'=>'box' , 'onClick'=>"window.location.href='".$this->base."/orders/checkout/cts:".$str."'" ) ) ;?>
  </td>
 </tr>
</table>