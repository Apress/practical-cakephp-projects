	...
	function __processActions() {
        ...
        foreach ( $securityAccess as $name_pair_key => $access_selection ) {
            ...
            if ( $access_selection == 'delete' ) {
                ...
                $aco_record = $aco->find( array(    "Aco.model" => $controller,
                                                    "Aco.alias" => $action ) );
            ...
            elseif ( $access_selection == 'include' ) {
                ...
                $aco_parent = new Aco();
                $aco_parent_record = $aco_parent->find( array(  "Aco.model" => $controller,
            ...
            while (false !== ($file = readdir($handle))) {
                ...
                if ($file != "." && $file != "..") {
                    ...
                    if ( is_file( APP.'controllers/'.$file ) ) {
                        ...
                        $file_contents = file_get_contents( APP.'controllers/'.$file );
